...
function resolveTargetEntries(identifier, dataDir) {
...
function printStatus(projectId, dbPath) {
...
async function printRemove(identifier, dataDir, requireConfirm = true) {
...
function printCleanup(days, dataDir) {
    const entries = enumerateGraphCache(dataDir);
    const now = Date.now();
...
async function runCleanup(days, dataDir, requireConfirm = true) {
