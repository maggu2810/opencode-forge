 ...
 */
export function openGraphDatabase(dbPath) {
 ...
 */
export function ensureGraphDirectory(projectId, dataDir, cwd) {
 ...
 */
export function initializeGraphDatabase(projectId, dataDir, cwd) {
 ...
 */
export function readGraphCacheMetadata(graphDir) {
    const metadataPath = join(graphDir, GRAPH_METADATA_FILE);
    if (!existsSync(metadataPath)) {
        return null;
    }
 ...
 */
export function writeGraphCacheMetadata(graphDir, metadata) {
    const metadataPath = join(graphDir, GRAPH_METADATA_FILE);
    try {
 ...
 */
export function closeGraphDatabase() {
