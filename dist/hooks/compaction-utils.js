export function buildCustomCompactionPrompt() {
...
export function extractCompactionSummary(messages) {
...
export function trimToTokenBudget(content, maxTokens, priority) {
