 ...
 */
function normalizeConfiguredLogDirectory(directory) {
 ...
 */
export function resolveWorktreeLogTarget(config, context, logger) {
 ...
 */
export function ensureWorktreeLogDirectory(hostPath, logger) {
    try {
 ...
 */
export function formatWorktreeCompletionEntry(options, planText) {
 ...
 */
export function appendWorktreeLogEntry(directory, options, planText, logger) {
    try {
 ...
 */
export function buildWorktreeCompletionPayload(config, options, logger) {
    const worktreeLogging = config.loop?.worktreeLogging;
    if (!worktreeLogging?.enabled) {
 ...
 */
export function writeWorktreeCompletionLog(payload, logger) {
    ...
    return appendWorktreeLogEntry(payload.logDirectory, {
        projectDir: payload.projectDir,
        loopName: payload.loopName,
        completionTimestamp: completionDate,
        iteration: payload.iteration,
        worktreeBranch: payload.worktreeBranch,
    }, payload.planText, logger);
}
//# sourceMappingURL=worktree-log.js.map